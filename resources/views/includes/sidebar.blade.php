    ...
    <ul class="list-group">
      <li class="list-group-item">
        <a href="{{ route('dashboard') }}" class="d-flex align-items-center text-decoration-none">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-richtext w-25" viewBox="0 0 16 16">
      ...
      <li class="list-group-item">
        <a href="{{ route('vacations.create') }}" class="d-flex align-items-center text-decoration-none">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-plus w-25" viewBox="0 0 16 16">
  ...
  <div class="exit-btn-wrapper">
    <form action="{{ route('logout') }}" method="POST">
      ...
      <button type="submit" class="exit-btn">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left w-25" viewBox="0 0 16 16">
